...
class OrderRefundAdapter :
    BaseQuickAdapter<OrderRefundItemBean, BaseDataBindingHolder<ItemOrdersGoodsBinding>>(R.layout.item_orders_goods) {
    ...
    override fun convert(
        ...
        holder.dataBinding?.apply {
            ...
            inGoodsInfo.tvTotal.visibility = View.GONE
            inGoodsInfo.tvTotalPrice.visibility = View.GONE
