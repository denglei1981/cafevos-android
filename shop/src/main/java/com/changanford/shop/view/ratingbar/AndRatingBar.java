package com.changanford.shop.view.ratingbar;
...
public class AndRatingBar extends AppCompatRatingBar implements AppCompatRatingBar.OnRatingBarChangeListener {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (typedArray.hasValue(R.styleable.AndRatingBar_rb_bgColor)) {
            if (right2Left) {
                mStarColor = typedArray.getColorStateList(
                        R.styleable.AndRatingBar_rb_bgColor);
            } else {
                mBgColor = typedArray.getColorStateList(
                        R.styleable.AndRatingBar_rb_bgColor);
            }
