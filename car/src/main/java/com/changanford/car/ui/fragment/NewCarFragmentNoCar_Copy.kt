...
class NewCarFragmentNoCar_Copy : BaseFragment<FragmentCarBinding, CarViewModel>() {
    ...
    private val headerBinding by lazy { DataBindingUtil.inflate<HeaderCar0Binding>(LayoutInflater.from(requireContext()), R.layout.header_car0, null, false) }
            ...
            registerOnPageChangeCallback(object : ViewPager2.OnPageChangeCallback() {
                override fun onPageSelected(position: Int) {
                    ...
                    topBannerList[position].apply {
                        this@NewCarFragmentNoCar_Copy.carModelCode=carModelCode
