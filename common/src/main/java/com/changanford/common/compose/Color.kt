package com.changanford.common.compose
...
val Color_E9E9 = Color(0xFFffe9e9)
val Color_F6F8 = Color(0xFFe6f6f8)
val Color_3344 = Color(0xFF2A3344)
val Color_5B73 = Color(0xFF4E5B73)
val Color_999 = Color(0xFF999999)

val Color_40fff = Color(0x40FFFFFF)
val Color_85A = Color(0xFFD2485A)
val Color_f2f2 = Color(0xFFf2f2f2)
val Color_B29 = Color(0xFF040B29)
val Color_B73 = Color(0xFF4E5B73)
val Color_2E9 = Color(0xFF81D2E9)
val Color_102E9 = Color(0x1081D2E9)
val Color_CCC = Color(0xFFCCCCCC)
val Color_20DCDC = Color(0x20DCDCDC)
val Color_4661 = Color(0xFFDF4661)
val Color_9FAB = Color(0xFFF29FAB)
val Color_F8F8 = Color(0xFFF8F8F8)
val Color_EEE = Color(0xFFEEEEEE)
val Color_95B = Color(0xFF1700f4)
val Color_20b89 = Color(0x201B3B89)
val Color_2095B = Color(0x201700f4)
