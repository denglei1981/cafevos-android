        ...
        binding?.let {
            ...
            if (!item.isCheck) {
                binding.tvCarName.background =
                    ContextCompat.getDrawable(context, R.drawable.bg_26ff_30)
                binding.tvCarName.setTextColor(ContextCompat.getColor(context,R.color.white))
            } else {
                binding.tvCarName.background =
                    ContextCompat.getDrawable(context, R.drawable.shape_whit30_bg)
                binding.tvCarName.setTextColor(ContextCompat.getColor(context,R.color.color_00095b))
            }
        }
    }
}