...
public class PictureUtils {
     ...
     * @return
     */
    public static final int maxvideoTime = 4 * 60; //秒
    public static final int minvideTime = 3; //秒
    public static final int maxPaisheTime = 70;
     ...
     *
     * @param activity
     * @param videoTime                最长时间秒
     * @param onResultCallbackListener
     */
    public static void opencarcmeVideo(Activity activity, int videoTime, OnResultCallbackListener onResultCallbackListener) {
        PictureSelector.create(activity)
                .openCamera(PictureMimeType.ofImage())
                .isUseCustomCamera(true)// 是否使用自定义相机
                .LuZhi()//新添加的方法 只打开自定义拍照功能
     ...
     * 单独打开自定义相机
     */
    public static void opencarcme(Activity activity, int CompressSize,OnResultCallbackListener onResultCallbackListener) {
        PictureSelector.create(activity)
                .openCamera(PictureMimeType.ofImage())
                .isUseCustomCamera(false)// 是否使用自定义相机
                .Paizhao()//新添加的方法 只打开自定义拍照功能
                ...
                .isCamera(true)
                .compressQuality(90)// 图片压缩后输出质量 0~ 100
                .minimumCompressSize(CompressSize)// 小于100kb的图片不压缩
                .loadImageEngine(GlideEngine.createGlideEngine())
                .forResult(onResultCallbackListener);
    }
     ...
     * 单独打开自定义相机
     */
    public static void opencarcme(Activity activity, OnResultCallbackListener onResultCallbackListener, int x, int y) {
        PictureSelector.create(activity)
                .openCamera(PictureMimeType.ofImage())
                .isUseCustomCamera(false)// 是否使用自定义相机
                .Paizhao()//新添加的方法 只打开自定义拍照功能
     ...
     * @param onResultCallbackListener
     */
    public static void openGarlly(Activity activity, OnResultCallbackListener onResultCallbackListener) {
        openGarlly(activity, 1, onResultCallbackListener);
    }
     ...
     * @param onResultCallbackListener
     */
    public static void openGarlly(int CompressSize, Activity activity, OnResultCallbackListener onResultCallbackListener) {
        openGarlly(CompressSize, activity, 1, onResultCallbackListener);
    }

    public static void openGarlly(Activity activity, int maxNum, ArrayList<LocalMedia> datas, OnResultCallbackListener onResultCallbackListener) {
        PictureSelector.create(activity)
...
//                    .hideBottomControls(!cb_hide.isChecked())// 是否显示uCrop工具栏，默认不显示
     ...
     * @param onResultCallbackListener
     */
    public static void openGarlly5(Activity activity, OnResultCallbackListener onResultCallbackListener) {
        PictureSelector.create(activity)
                .openGallery(PictureMimeType.ofImage())// 全部.PictureMimeType.ofAll()、图片.ofImage()、视频.ofVideo()、音频.ofAudio()
                .imageEngine(GlideEngine.createGlideEngine())// 外部传入图片加载引擎，必传项
                .theme(R.style.picture_WeChat_style)// 主题样式设置 具体参考 values/styles   用法：R.style.picture.white.style v2.3.3后 建议使用setPictureStyle()动态方式
...
//                .selectionData(datas)// 是否传入已选图片
    ...
    public static void openGarlly3(Activity activity, OnResultCallbackListener onResultCallbackListener) {
        PictureSelector.create(activity)
...
//                .selectionData(datas)// 是否传入已选图片
    ...
    public static void openGarlly(Activity activity, int maxNum, OnResultCallbackListener onResultCallbackListener) {
        openGarlly(activity, maxNum, false, onResultCallbackListener);
    }

    /**
     * 直接打开相册
     */
    public static void openGarlly(Activity activity, int maxNum, boolean isCompress, OnResultCallbackListener onResultCallbackListener) {
        // 进入相册 以下是例子：不需要的api可以不写
        PictureSelector.create(activity)
                .openGallery(PictureMimeType.ofImage())// 全部.PictureMimeType.ofAll()、图片.ofImage()、视频.ofVideo()、音频.ofAudio()
                .imageEngine(GlideEngine.createGlideEngine())// 外部传入图片加载引擎，必传项
...
//                    .hideBottomControls(!cb_hide.isChecked())// 是否显示uCrop工具栏，默认不显示
     ...
     * 直接打开相册
     */
    public static void openHeadGarlly(Activity activity, int maxNum, boolean isCompress, OnResultCallbackListener onResultCallbackListener) {
        // 进入相册 以下是例子：不需要的api可以不写
        PictureSelector.create(activity)
                .openGallery(PictureMimeType.ofImage())// 全部.PictureMimeType.ofAll()、图片.ofImage()、视频.ofVideo()、音频.ofAudio()
                .imageEngine(GlideEngine.createGlideEngine())// 外部传入图片加载引擎，必传项
...
//                    .hideBottomControls(!cb_hide.isChecked())// 是否显示uCrop工具栏，默认不显示
     ...
     * 直接打开相册 裁剪固定宽高
     */
    public static void openGarlly(Activity activity, int maxNum, OnResultCallbackListener onResultCallbackListener, int x, int y) {
        // 进入相册 以下是例子：不需要的api可以不写
        PictureSelector.create(activity)
                .openGallery(PictureMimeType.ofImage())// 全部.PictureMimeType.ofAll()、图片.ofImage()、视频.ofVideo()、音频.ofAudio()
                .imageEngine(GlideEngine.createGlideEngine())// 外部传入图片加载引擎，必传项
