 ...
 *     并设置本司服务器的回调地址
 *     ---> 上传成功后oss会前设根据之置的回调通知本司服务器 本地也会收到关于oss的上传回调
 *
...
public class AliYunOssUploadOrDownFileConfig {
    ...
    public void uploadFile(String bucketName, String objectKey,
        ...
        uploadFile(false,null,bucketName,objectKey,uploadFilePath,filename,reminderId);
    }
    /**
     * 上传文件
     * @param bucketName oss上所建的仓库名称  eg : smartDev 如果设置的合理，将会报错，oss会提示说设置的bucketName不可用
     ...
     * @param uploadFilePath 本地存储文件的路径
     */
    public void uploadFile(boolean isBase64,byte[] bytes, String bucketName, String objectKey,
                           String uploadFilePath, final String filename, final int reminderId){
...
//                    put(CALLBACK_BODY,"filename=${object}");
        ...
        put.setProgressCallback(new OSSProgressCallback<PutObjectRequest>() {
            ...
            public void onProgress(PutObjectRequest request, long currentSize, long totalSize) {
                ...
                onUploadFile.onuploadFileprogress( request, currentSize,  totalSize);
            }
        });
    ...
    public interface OnUploadFile {
        ...
        void onuploadFileprogress(PutObjectRequest request, long currentSize, long totalSize);
    }
