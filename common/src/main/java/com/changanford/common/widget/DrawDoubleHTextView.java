...
public class DrawDoubleHTextView extends ConstraintLayout {
    ...
    public DrawDoubleHTextView(Context context) {
        this(context, null);
    }

    public DrawDoubleHTextView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressLint("CustomViewStyleable")
    public DrawDoubleHTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);

        //加载视图的布局
        LayoutInflater.from(context).inflate(R.layout.layout_draw_double_h_text, this, true);
