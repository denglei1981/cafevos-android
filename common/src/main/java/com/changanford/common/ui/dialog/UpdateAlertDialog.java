...
public class UpdateAlertDialog {
    ...
    public UpdateAlertDialog builder() {
        View view = LayoutInflater.from(context).inflate(
                R.layout.update_alert_dialog, null);
     ...
     * @return
     */
    public UpdateAlertDialog setGone() {
        if (lLayout_bg != null) {
    ...
    public UpdateAlertDialog setPositiveButton(String text, int color,
                                               final OnClickListener listener) {
        showPosBtn = true;
        if ("".equals(text)) {
            btn_pos.setText("");
...
//        btn_pos.setTextColor(ContextCompat.getColor(context, color));
    ...
    public UpdateAlertDialog setNegativeButton(String text, int color,
                                               final OnClickListener listener) {
        showNegBtn = true;
        if ("".equals(text)) {
            btn_neg.setText("");
