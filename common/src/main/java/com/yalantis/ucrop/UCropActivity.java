...
//            menuItemCropIcon.setColorFilter(colorFilter);
    ...
    protected void setupViews(@NonNull Intent intent) {
        ...
        mToolbarCancelDrawable = intent.getIntExtra(UCrop.Options.EXTRA_UCROP_WIDGET_CANCEL_DRAWABLE, R.drawable.picture_icon_back_arrow);
    ...
    private void setupAppBar() {
        ...
        toolbarTitle.setTextColor(getResources().getColor(R.color.ucrop_color_black));
