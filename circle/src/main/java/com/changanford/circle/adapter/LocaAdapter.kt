...
class LocaAdapter : BaseQuickAdapter<PoiInfo, BaseViewHolder>(R.layout.loca_item) {
    ...
    override fun convert(baseViewHolder: BaseViewHolder, poiInfo: PoiInfo) {
        var tvname = baseViewHolder.getView<TextView>(R.id.tv_name)
        var tvaddress = baseViewHolder.getView<TextView>(R.id.tv_address)
