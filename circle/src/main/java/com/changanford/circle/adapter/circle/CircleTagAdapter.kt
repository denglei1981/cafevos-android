...
class CircleTagAdapter(var tagMaxCount:Int=0,private val listener:OnPerformListener): BaseQuickAdapter<NewCirceTagBean, BaseDataBindingHolder<ItemCreateCircleTagBinding>>(R.layout.item_create_circle_tag){
